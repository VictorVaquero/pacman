...
class tablaEstados:
    ...
    def brute_get(self, jugador, fantasma, tablero, movimiento):
        return self.tabla.get((jugador, fantasma, tablero, movimiento),
                              self.DEFAULT)
    ...
    def get(self, jugador, fantasma, tablero, movimiento):
        return self.metodos_get[self.metodo](jugador, fantasma,
                                             tablero, movimiento)

    def set(self, jugador, fantasma, tablero, movimiento, value):
        self.metodos_set[self.metodo](
            jugador, fantasma, tablero, movimiento, value)
